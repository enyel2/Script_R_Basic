...
boot1  <- boot(grav1, diff.means, R = 999, stype = "f", strata = grav1[,2])
boot2 <- boot.array(boot1, indices = FALSE)
...
# that two extra arguments to statistic
# are passed through boot.
